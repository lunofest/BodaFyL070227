const CACHE_NAME = 'cache-v77'; // Use a static or manually managed version
const RESOURCES_TO_PRECACHE = [
    'estilos/normalize.css?v77',
    'estilos/styles.css?v77',
    'estilos/mediaQueries.css?v77',
    'javascript/script.js?v77',
