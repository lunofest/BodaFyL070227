const CACHE_NAME = 'cache-v70'; // Use a static or manually managed version
const RESOURCES_TO_PRECACHE = [
    'estilos/normalize.css?v70',
    'estilos/styles.css?v70',
    'estilos/mediaQueries.css?v70',
    'javascript/script.js?v70',
